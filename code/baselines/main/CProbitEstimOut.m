...
classdef CProbitEstimOut < EstimOut
    ...
    methods
        ...
        %                      CONSTRUCTOR METHOD
        % *****************************************************************
        function obj = CProbitEstimOut(Y, Mean, Var, maxsumval)
            obj = obj@EstimOut;
        ...
        function obj = set.Y(obj, Y)
            Y_real = real(Y);
            Y_imag = imag(Y);
            % consider both the real and imaginary parts
        ...
        function [Zhat, Zvar] = estim(obj, Phat, Pvar)
            ...
            obj_real = ProbitEstimOut(real(obj.Y), real(obj.Mean), 1/2*obj.Var, obj.maxSumVal);
            obj_imag = ProbitEstimOut(imag(obj.Y), imag(obj.Mean), 1/2*obj.Var, obj.maxSumVal);
